...
namespace MystifyFX {
    ...
    public class ContactUsWindow : EditorWindow {
        const string OnlineGuidesUrl = "https://kronnect.com/docs/mystify-fx/";
        const string SupportUrl = "https://kronnect.com/docs/mystify-fx/";
        ...
        const string ReferralInfo = "?aid=1101lGsd&pubref=mystifyfx";
    ...
    new AssetCategory
    {
        ...
        public static void ShowScreen () {
            ContactUsWindow window = GetWindow<ContactUsWindow>(true, "Online Resources & Support", true);

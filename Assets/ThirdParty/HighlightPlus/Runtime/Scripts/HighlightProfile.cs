...
namespace HighlightPlus {
    ...
    public class HighlightProfile : ScriptableObject {
        ...
        public void Load (HighlightEffect effect) {
            ...
            effect.targetFXOffScreenIndicator = targetFXOffScreenIndicator;
            effect.targetFXOffScreenIndicatorTexture = targetFXOffScreenIndicatorTexture;
            effect.targetFXScreenMargin = targetFXScreenMargin;
            effect.targetFXPointToTarget = targetFXPointToTarget;
            effect.targetFXScreenSize = targetFXScreenSize;
        ...
        public void Save (HighlightEffect effect) {
            ...
            targetFXOffScreenIndicator = effect.targetFXOffScreenIndicator;
            targetFXOffScreenIndicatorTexture = effect.targetFXOffScreenIndicatorTexture;
            targetFXScreenMargin = effect.targetFXScreenMargin;
            targetFXPointToTarget = effect.targetFXPointToTarget;
            targetFXScreenSize = effect.targetFXScreenSize;
